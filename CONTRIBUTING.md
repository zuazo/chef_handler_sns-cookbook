...
6. [Run the tests](https://github.com/onddo/chef_handler_sns-cookbook/blob/master/TESTING.md), ensuring they all pass (`$ bundle exec rake`). Try as much as possible **not to reduce coverage**.
